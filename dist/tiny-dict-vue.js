...
var Dict = /** @class */ (function () {
    function Dict(options) {
        ...
        this.store = isVue3 ? vue_1.reactive({}) : vue_2.default.observable({});
    ...
    Dict.prototype.createAsyncMemo = function () {
        var _this = this;
        var func = function (key) { return __awaiter(_this, void 0, void 0, function () {
            var error_1;
        ...
        var options = { promise: true, max: this.max.async };
        return memoize(func, options);
    };
    Dict.prototype.createFilterMemo = function () {
        var _this = this;
        var func = function (key, value) {
            return _this.excuteFilter(_this.store[key], value, _this.getConfig(key).props);
        };
        var options = { max: this.max.filter };
        return memoize(func, options);
    };
    ...
    Dict.prototype.addStoreProp = function (key, data) {
        if (!Reflect.has(this.store, key))
            isVue3 ? (this.store[key] = data) : vue_2.default.set(this.store, key, data);
    };
